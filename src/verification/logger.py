...
class VerificationLogger:
    ...
    def log_verification_success(self, appimage_name: str, verification_type: str = "hash") -> None:
        ...
        """
        message = f"{STATUS_SUCCESS}{verification_type.title()} verification passed for {appimage_name}"
    ...
    def log_verification_failure(self, appimage_name: str, verification_type: str = "hash") -> None:
        ...
        """
        message = f"{STATUS_FAIL}{verification_type.title()} verification failed for {appimage_name}"
