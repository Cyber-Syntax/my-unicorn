...
def mocked_parser(monkeypatch: pytest.MonkeyPatch, download_test_data: tuple[str, str]) -> MagicMock:
    ...
    monkeypatch.setattr("my_unicorn.commands.install_url.ParseURL", parser_class_mock)
    return mock
...
def mocked_app_config(
    ...
    monkeypatch.setattr("my_unicorn.commands.install_url.AppConfigManager", app_config_class_mock)
    return mock
...
def mocked_api(monkeypatch: pytest.MonkeyPatch, download_test_data: tuple[str, str]) -> MagicMock:
    ...
    monkeypatch.setattr("my_unicorn.commands.install_url.GitHubAPI", api_class_mock)
    return mock
...
def mocked_download_manager(monkeypatch: pytest.MonkeyPatch) -> MagicMock:
    ...
    monkeypatch.setattr("my_unicorn.commands.install_url.DownloadManager", download_manager_class_mock)
    return mock
...
def mocked_global_config(monkeypatch: pytest.MonkeyPatch) -> MagicMock:
    ...
    monkeypatch.setattr("my_unicorn.global_config.GlobalConfigManager", global_config_class_mock)
    return mock
...
def mocked_verifier(
    ...
    monkeypatch.setattr("my_unicorn.commands.install_url.VerificationManager", verifier_class_mock)
    return mock
...
def mocked_file_handler(monkeypatch: pytest.MonkeyPatch) -> MagicMock:
    ...
    monkeypatch.setattr("my_unicorn.commands.install_url.FileHandler", file_handler_class_mock)
    return mock
...
def mocked_icon_manager(monkeypatch: pytest.MonkeyPatch) -> MagicMock:
    ...
    monkeypatch.setattr("my_unicorn.commands.install_url.IconManager", icon_manager_class_mock)
    return mock
