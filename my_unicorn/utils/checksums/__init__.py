...
Example usage:
    ...
    from my_unicorn.utils.checksums.extractor import extract_checksums_from_text
...
from my_unicorn.utils.checksums.extractor import (
...
def extract_checksums(owner: str, repo: str, appimage_name: str | None) -> ChecksumList:
    ...
    my_unicorn.verification.release_desc_verifier for verification workflows.
    ...
    logger.warning(
        ...
        "my_unicorn.verification.release_desc_verifier instead."
    )
